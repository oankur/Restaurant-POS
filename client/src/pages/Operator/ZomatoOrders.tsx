...
export default function ZomatoOrders() {
  ...
  useEffect(() => {
    ...
    socket.on('new_order', (order: Order) => {
      if (order.source === 'ZOMATO') { setOrders((prev) => [order, ...prev]); toast.success('New Zomato order!'); }
    });
  ...
  return (
    <div className="flex flex-col flex-1 overflow-hidden bg-[#F7F5F2]" style={{ height: '100%' }}>
      <header className="bg-white border-b border-gray-200 px-6 py-4 flex items-center gap-3 flex-shrink-0">
        ...
        <div>
          <h1 className="font-bold text-gray-900">Zomato Orders</h1>
              ...
              <div className="flex items-start justify-between mb-3">
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="bg-red-100 text-red-700 text-xs px-2 py-0.5 rounded-full font-medium">ZOMATO</span>
